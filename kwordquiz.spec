...
Version  : 21.12.0
Release  : 34
URL      : https://download.kde.org/stable/release-service/21.12.0/src/kwordquiz-21.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kwordquiz-21.12.0.tar.xz
...
%prep
%setup -q -n kwordquiz-21.12.0
cd %{_builddir}/kwordquiz-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639611961
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwordquiz-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kwordquiz/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kwordquiz-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwordquiz/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kwordquiz-21.12.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kwordquiz/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kwordquiz-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwordquiz/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang kwordquiz
