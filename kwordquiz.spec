...
Version  : 24.12.2
Release  : 75
URL      : https://download.kde.org/stable/release-service/24.12.2/src/kwordquiz-24.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kwordquiz-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kwordquiz-24.12.2.tar.xz.sig
...
%setup -q -n kwordquiz-24.12.2
cd %{_builddir}/kwordquiz-24.12.2
pushd ..
cp -a kwordquiz-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738950259
mkdir -p clr-build
pushd clr-build
