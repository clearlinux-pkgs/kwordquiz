...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kwordquiz-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kwordquiz-24.12.3.tar.xz.sig
...
%setup -q -n kwordquiz-24.12.3
cd %{_builddir}/kwordquiz-24.12.3
pushd ..
cp -a kwordquiz-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742432203
mkdir -p clr-build
pushd clr-build
