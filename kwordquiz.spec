...
Version  : 22.04.3
Release  : 41
URL      : https://download.kde.org/stable/release-service/22.04.3/src/kwordquiz-22.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kwordquiz-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kwordquiz-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kwordquiz-22.04.3
cd %{_builddir}/kwordquiz-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657557990
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwordquiz-22.04.3/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kwordquiz/ee03d68f6be20b170e5ea5d114d6acafb3f2d1dc
cp %{_builddir}/kwordquiz-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwordquiz/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kwordquiz-22.04.3/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kwordquiz/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/kwordquiz-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwordquiz/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang kwordquiz
